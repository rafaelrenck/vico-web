...
export default function TableAppointments({
  ...
  return (
    <Table colorScheme="whiteAlpha" appointments={appointments}>
      <Thead>
        <Tr>
          <Th textAlign="center" pl="1rem" pr="2rem">
            Data
          </Th>
          <Th w="100%">Paciente</Th>
          <Th textAlign="center" pr="2rem">
            Tipo
          </Th>
          <Th textAlign="center" px="0" minW="4rem">
            Conta
          </Th>
          <Th textAlign="center" px="0" minW="4rem">
            TISS
          ...
          <Th textAlign="center" pl="2rem" pr="1rem">
            Upload
          </Th>
        </Tr>
      </Thead>
              ...
              <Td textAlign="center" whiteSpace="nowrap" pl="1rem" pr="2rem">
                <Stack alignItems="center" spacing="0.2rem" fontSize="0.8rem">
                  <Flex alignItems="center">
                    <Text>
                      {format(parseISO(appointment.date), "dd/MM/yy")}
                    </Text>
                  </Flex>
              ...
              <Td>
                <Stack spacing="0.2rem">
                  ...
                  <HStack spacing="2rem" color="gray.600" fontSize="0.8rem">
                    <Text>
                      Registro:
                      <Text as="span" ml="0.5rem" fontWeight="bold">
